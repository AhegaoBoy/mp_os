...
TEST(positiveTests, test1)
{
    ...
    auto actual_blocks_state1 = dynamic_cast<allocator_test_utils *>(subject)->get_blocks_info();
    ...
    auto actual_blocks_state2 = dynamic_cast<allocator_test_utils *>(subject)->get_blocks_info();
